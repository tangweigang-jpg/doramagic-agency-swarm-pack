...
```text
Using this pack, identify the first safe verification step for give AI coding hosts a verifiable agency-swarm workflow with multi-agent coordination rules, boundary checks, and recovery steps for agent communication failures.
