...
This repository is an independent Doramagic AI context resource pack for VRSEN/agency-swarm.
...
Do not use this repository as the upstream project's support tracker. If the bug is in VRSEN/agency-swarm itself, report it to https://github.com/VRSEN/agency-swarm/issues first and link the upstream issue here only when it changes this pack.
